---
name: Spacing scale
description: Official spacing scale (gap, padding, margin, space-y) and Tailwind values allowed
type: design
---
...
**Exception**: 0.5 is allowed for fine optical adjustments (e.g. mt-0.5 to nudge icons inline with text).
