        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                min={1}
                placeholder="Ex: 30"
                value={effectiveConfig?.cadence_days ?? 30}
                onChange={e => setConfigForm((p: any) => ({ ...(p || {}), cadence_days: Number(e.target.value) }))}
                className="h-9"
                readOnly={!isOwner}
              />
            ...
            <div className="space-y-1.5">
              ...
              <Select
                value={effectiveConfig?.responsible_id || ''}
                onValueChange={v => setConfigForm((p: any) => ({ ...(p || {}), responsible_id: v }))}
                disabled={!isOwner}
              >
          ...
          <div className="space-y-1.5">
            ...
            <Textarea
              ...
              value={effectiveConfig?.collection_message || ''}
              onChange={e => setConfigForm((p: any) => ({ ...(p || {}), collection_message: e.target.value }))}
