...
export const ALL_SECTIONS_ROW2: SectionDef[] = [
  ...
  { path: '/hub/financeiro/fornecedores', label: 'Lista de Fornecedores', icon: Truck, iconColor: 'text-muted-foreground', color: 'from-border/20 to-border/10 border-border/60 hover:from-border/30 hover:to-border/15 hover:border-border/80', key: 'fornecedores' },
