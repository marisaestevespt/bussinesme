  ...
  return (
    <div className="space-y-6 mt-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Card><CardContent className="pt-4"><p className="text-xs text-muted-foreground">Saídas Previstas (s/ IVA)</p><p className="text-lg font-bold text-destructive">{formatEuro(totals.saidas)}</p></CardContent></Card>
