...
const TYPE_COLORS: Record<DiffType, string> = {
  missing_payment: 'bg-amber-100 text-amber-900 dark:bg-amber-950 dark:text-amber-200',
  missing_expense: 'bg-orange-100 text-orange-900 dark:bg-orange-950 dark:text-orange-200',
  status_mismatch: 'bg-blue-100 text-blue-900 dark:bg-blue-950 dark:text-blue-200',
  value_mismatch: 'bg-red-100 text-red-900 dark:bg-red-950 dark:text-red-200',
};
