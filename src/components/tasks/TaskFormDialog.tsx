        ...
        <DialogContent className="max-w-3xl w-[95vw] max-h-[92vh] overflow-y-auto p-0 gap-0">
          ...
          <DialogHeader className="px-8 pt-6 pb-5 border-b border-border/60 bg-muted/30 shrink-0 space-y-2">
            ...
            <Input
              ...
              className="h-auto text-[26px] font-bold leading-tight tracking-tight border-0 shadow-none focus-visible:ring-0 px-0 py-0 placeholder:text-muted-foreground/40 bg-transparent text-foreground"
            />
          </DialogHeader>
