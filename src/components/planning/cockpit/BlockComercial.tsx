  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <Link to="/hub/comercial?tab=vendas" className="hq-surface-sunken rounded-lg p-3 hover:bg-accent/40 hq-transition block" target="_blank" rel="noopener noreferrer">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
        ...
        <div className="hq-surface-sunken rounded-lg p-3 space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Button asChild size="sm" variant="ghost" className="h-6 text-[10px] px-2">
              <Link to="/hub/comercial" target="_blank" rel="noopener noreferrer">Ver todas →</Link>
            </Button>
          </div>
          {data.sales.length === 0 ? (
        ...
        <div className="hq-surface-sunken rounded-lg p-3 space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Button asChild size="sm" variant="ghost" className="h-6 text-[10px] px-2">
              <Link to="/hub/produtos" target="_blank" rel="noopener noreferrer"><Plus className="h-3 w-3" /></Link>
            </Button>
          </div>
            ...
            <ul className="space-y-1 max-h-40 overflow-auto pr-1">
              {data.activeProducts.map((p: any) => (
                <li key={p.id} className="flex items-center gap-2 text-xs">
                  <Link to={`/hub/produtos/${p.id}`} className="truncate flex-1 hover:underline font-medium" target="_blank" rel="noopener noreferrer">{p.name}</Link>
