...
const badgeVariants = cva(
  "inline-flex items-center rounded-sm border px-2 py-0.5 font-typewriter text-[10px] uppercase tracking-[0.14em] transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
