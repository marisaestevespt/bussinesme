...
export function ImpersonationBanner() {
  ...
  return (
    <div className="sticky top-0 z-50 w-full bg-amber-500/95 text-amber-950 border-b border-amber-700/40 backdrop-blur-sm">
      <div className="flex items-center justify-between gap-3 px-4 py-2 text-sm">
        ...
        <Button
          size="sm"
          variant="outline"
          className="h-7 bg-white/80 hover:bg-white border-amber-700/40"
