                ...
                <Card className="border-border/60">
                  <CardContent className="p-5 space-y-3">
                    <div className="flex items-center gap-2">
                      ...
                      <h3 className="text-sm font-semibold text-foreground">Conteúdo / Copy</h3>
                    </div>
                    <RichTextEditor
                      content={form.copy_content}
                      onChange={v => setForm(f => ({ ...f, copy_content: v }))}
                      editable
                      placeholder="Escreve o copy do teu conteúdo... (ou define um formato acima para usar um template estruturado)"
                    />
                  </CardContent>
                </Card>
              )}
