...
const SECTIONS = [
  ...
  { path: '/hub/financeiro/setup-negocio', label: 'Setup de Negócio', icon: Settings, iconColor: 'text-slate-600', color: 'from-slate-500/10 to-slate-600/5 hover:from-slate-500/20 hover:to-slate-600/10' },
];
