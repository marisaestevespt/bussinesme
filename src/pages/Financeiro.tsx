...
const ALL_SECTIONS_ROW2 = [
  ...
  { path: '/hub/financeiro/metas-financeiras', label: 'Metas', icon: Target, iconColor: 'text-pink-600', color: 'from-pink-500/20 to-pink-600/10 border-pink-200/60 hover:from-pink-500/30 hover:to-pink-600/15 hover:border-pink-300/80', key: 'metas' },
