...
import { ManageTacticalAreasDialog } from '@/components/planning/ManageTacticalAreasDialog';
...
export default function ExecutivePlaneamentoTatico() {
  ...
  return (
    <AppLayout>
      <div className="space-y-8">
        ...
        <section className="space-y-6">
          <div className="flex items-center justify-between gap-2">
            ...
            <Button variant="outline" size="sm" onClick={() => setManageOpen(true)} className="gap-2 shrink-0">
      ...
      <ManageTacticalAreasDialog open={manageOpen} onOpenChange={setManageOpen} />
    </AppLayout>
  );
}
