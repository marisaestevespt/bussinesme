...
BEGIN
  ...
  _result := jsonb_build_object(
    ...
    'primary_color',  COALESCE(NULLIF(_bs.primary_color, ''), '351 56% 28%'),
    'accent_color',   COALESCE(NULLIF(_bs.accent_color, ''), '26 40% 39%'),
    'text_color',     COALESCE(NULLIF(_bs.text_color, ''), '0 0% 16%'),
