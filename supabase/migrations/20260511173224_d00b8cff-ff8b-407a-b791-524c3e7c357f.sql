...
DECLARE
  ...
  _br_text    text;
BEGIN
  SELECT cp.client_id, cp.playlist_url INTO _client_id, _portal_playlist
  ...
  _result := jsonb_build_object(
    ...
    'playlist_url',   COALESCE(NULLIF(_portal_playlist, ''), NULLIF(_pb->>'playlist_url', '')),
