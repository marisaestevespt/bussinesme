...
DECLARE
  ...
  _exists boolean;
BEGIN
  -- Setup: profile + member fictício
  INSERT INTO profiles (user_id, full_name) VALUES (gen_random_uuid(), '__test_profile_'||_ts) RETURNING id INTO _profile_id;
  INSERT INTO team_members (full_name, email, contract_type, status, profile_id)
  VALUES ('__test_member_'||_ts, 'test_'||_ts||'@test.com', 'recibos_verdes', 'ativo', _profile_id)
  ...
  -- Atualizar para adicionar member_id
