...
export const template = {
  ...
  previewData: {
    ...
    html: '<div style="background:#f5f5f7;padding:24px;font-family:DM Sans,Arial,sans-serif"><div style="max-width:584px;margin:0 auto;background:#ffffff;border-radius:20px;padding:8px 28px 28px;box-shadow:0 1px 2px rgba(0,0,0,0.04),0 8px 24px rgba(0,0,0,0.06)"><div style="background:linear-gradient(135deg,#6366f1 0%,#8b5cf6 100%);padding:32px 28px;color:#ffffff;border-radius:16px 16px 0 0;margin:-8px -28px 0"><p style="font-size:11px;letter-spacing:1.6px;text-transform:uppercase;opacity:0.78;margin:0 0 8px;font-weight:500">Wrap-up do dia</p><h1 style="font-size:24px;line-height:1.3;margin:0 0 6px;font-weight:600">Boa noite, Tiago!</h1><p style="font-size:13px;opacity:0.82;margin:0">Sexta-feira, 1 de Maio</p></div><div style="margin:18px 0 0;border-radius:14px;background:#fafafa;border:1px solid #efeff1;overflow:hidden"><div style="padding:18px 22px 16px;border-left:3px solid #6366f1"><h2 style="font-size:13px;font-weight:600;color:#1c1c1e;margin:0 0 12px;letter-spacing:0.2px">✅ Concluído hoje</h2><div style="font-size:14px;color:#3a3a3c;line-height:1.6"><div style="padding:8px 0;border-bottom:1px solid #efeff1">3 tarefas concluídas 🌟</div><div style="padding:8px 0;border-bottom:1px solid #efeff1">2 reuniões participadas</div><div style="padding:8px 0">1 entrega submetida — Página de pagamentos</div></div></div></div><div style="margin:18px 0 0;border-radius:14px;background:#fafafa;border:1px solid #efeff1;overflow:hidden"><div style="padding:18px 22px 16px;border-left:3px solid #6366f1"><h2 style="font-size:13px;font-weight:600;color:#1c1c1e;margin:0 0 12px;letter-spacing:0.2px">⚠️ Por terminar</h2><div style="font-size:14px;color:#3a3a3c;line-height:1.6"><div style="padding:8px 0;border-bottom:1px solid #efeff1">1 tarefa em atraso — Fix bug login</div><div style="padding:8px 0">1 tarefa para amanhã — Refactor tabela</div></div></div></div><div style="margin:18px 0 0;border-radius:14px;background:#fafafa;border:1px solid #efeff1;overflow:hidden"><div style="padding:18px 22px 16px;border-left:3px solid #6366f1"><h2 style="font-size:13px;font-weight:600;color:#1c1c1e;margin:0 0 12px;letter-spacing:0.2px">🌅 Amanhã</h2><div style="font-size:14px;color:#3a3a3c;line-height:1.6"><div style="padding:8px 0;border-bottom:1px solid #efeff1">1 reunião marcada — Sprint planning 10h</div><div style="padding:8px 0">4 tarefas no plano do dia</div></div></div></div></div></div>',
  },
