...
const ClientOffboardingEmail = ({
  ...
  const text = { fontSize: '15px', color: brandMuted, lineHeight: '1.7', margin: '0 0 16px' }
  const highlight = { backgroundColor: '#f7f7fa', borderRadius: '10px', padding: '20px', marginBottom: '16px' }
  const highlightTitle = { fontSize: '15px', fontWeight: '600' as const, color: brandText, margin: '0 0 8px' }
  const highlightDesc = { fontSize: '14px', color: brandMuted, lineHeight: '1.6', margin: '0' }
